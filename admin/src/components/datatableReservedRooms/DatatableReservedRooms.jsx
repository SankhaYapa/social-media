...
const DatatableReservedRooms = () => {
  ...
  useEffect(() => {
    const fetchReservedRooms = async () => {
      try {
        const response = await axios.get("http://localhost:8800/api/hotels/reserved-rooms");
  ...
  const columns = [
    { field: "guestEmail", headerName: "Guest Email", width: 150 },
    { field: "guestName", headerName: "Guest Name", width: 200 },
    { field: "roomId", headerName: "RoomId", width: 250 },
...
export default DatatableReservedRooms;
